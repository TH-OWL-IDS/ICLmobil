...
export default {
  async assetLock(data) {
    return axios
      .post(store.getters.getApiHost + store.getters.getApiUrl + '/assets/lock', data, {
        headers: {
  ...
  async assetUnlock(data) {
    return axios
      .post(store.getters.getApiHost + store.getters.getApiUrl + '/assets/unlock', data, {
        headers: {
          Authorization: `Bearer ${store.getters.getUserToken}`
        }
      })
