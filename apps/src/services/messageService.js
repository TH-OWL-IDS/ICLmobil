...
export default {
  async getMessages() {
    return axios
      .get(store.getters.getApiHost + store.getters.getApiUrl + '/user/message/list', {
        headers: {
  ...
  async registerPushToken(data) {
    return axios
      .post(store.getters.getApiHost + store.getters.getApiUrl + '/user/device/registerPushToken', data, {
        headers: {
          Authorization: `Bearer ${store.getters.getUserToken}`
        }
      })
  ...
  async deleteMessage(data) {
    return axios
      .delete(store.getters.getApiHost + store.getters.getApiUrl + '/user/message', {
        headers: {
          Authorization: `Bearer ${store.getters.getUserToken}`
        },
        params: {
